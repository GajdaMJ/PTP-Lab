...
sol_tanks = CSTR_model(initial_temperature, water_flowrate_c, aah_flowrate_c, V=137)

#plt.plot(elapsed_time, sol_tanks[6][1][:, 3]-sol_tanks[6][1][0,3], color = 'red',label=f'Temperature Tank {8}')
plt.plot(elapsed_time, temp_c)
plt.show()