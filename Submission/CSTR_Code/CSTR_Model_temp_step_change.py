...
def CSTR_model(T1, T2,fv1,fv2, V=500, tspan = [0,3600], t_change=1800):
    ...
    Required Arguments: \n
    T1 = initial inlet temperature for the reactor given in units celsius \n
    T2 = secondary inlet temperature also celsius \n
    ...
    t_change = time at which change in temperature occurs in seconds (default=1800s) \n
